...
uint256 hashGenesisBlock("0x0000000088dbc8422d1daadbbc2cf492de779223f6bf83e773298136fb48c242");
...
const string strMessageMagic = "DASHLiTE Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 1750 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 1750);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 28800;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000088dbc8422d1daadbbc2cf492de779223f6bf83e773298136fb48c242");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1432111768;
        block.nBits    = 486604799;
        block.nNonce   = 2896644517;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DASHLiTEMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DASHLiTEMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running DASHLiTEMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("DASHLiTEMiner terminated\n");
        throw;
    }
}
